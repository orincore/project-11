        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <h1 className={`text-5xl sm:text-6xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              React <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
                Animation Guide
              </span>
            </h1>
            <p className={`text-xl mb-8 max-w-3xl mx-auto ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Master React animations with real examples, live previews, and copyable code snippets using Framer Motion
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-black/20'} font-mono text-sm`}>
              ...
              <div className="flex items-center justify-between">
                <span className="font-mono">npm install framer-motion</span>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
            ...
            <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-black/20'} font-mono text-sm mt-2`}>
              <div className="flex items-center mb-2">
                <span className="w-3 h-3 bg-red-500 rounded-full mr-1"></span>
                <span className="w-3 h-3 bg-yellow-400 rounded-full mr-1"></span>
                <span className="w-3 h-3 bg-green-500 rounded-full"></span>
              ...
              <div className="flex items-center justify-between">
                <span className="font-mono">import &#123; motion, AnimatePresence &#125; from 'framer-motion';</span>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
